...
def generate_launch_description():
  ...
  package_name_description = 'delta_robot_description'
  package_name_gazebo = 'delta_robot_gazebo'

  default_robot_name = 'delta_robot'
  gazebo_launch_file_path = 'launch'
  gazebo_models_path = 'models'
  rviz_config_file_path = 'rviz/delta_robot.rviz'
  urdf_file_path = 'urdf/ros2_control/classic_gazebo/delta_robot.urdf.xacro'
...
# ros2 topic pub --once /arm_controller/joint_trajectory trajectory_msgs/msg/JointTrajectory "{joint_names: ['motor_1', 'motor_2', 'motor_3'], points: [{positions: [0.5, 0.5, 0.5], time_from_start: {sec: 5, nanosec: 0}}]}"